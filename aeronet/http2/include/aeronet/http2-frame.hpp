...
// TODO: Simplify constructor to avoid zero initialization overhead
struct FrameHeader {
  ...
  uint32_t length{0};  ///< Payload length (24 bits, max 16777215)
  FrameType type{FrameType::Data};
  uint8_t flags{0};
  uint32_t streamId{0};  ///< 31-bit stream identifier
};
