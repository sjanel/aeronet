function(AeronetSetProjectProperties name)
  ...
  if(AERONET_ENABLE_WARNINGS)
    if(CMAKE_BUILD_TYPE STREQUAL "Debug")
      ...
      elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
        target_compile_options(${name} PRIVATE /W4 /external:anglebrackets /external:W0)
      endif()
    endif()
  endif()
  ...
  if(AERONET_ENABLE_HTTP_CLIENT)
    target_compile_definitions(${name} PUBLIC AERONET_ENABLE_HTTP_CLIENT)
  endif()
  if(AERONET_ENABLE_RESPONSE_CACHE)
    target_compile_definitions(${name} PUBLIC AERONET_ENABLE_RESPONSE_CACHE)
  endif()
