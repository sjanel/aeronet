...
- **HTTP CONNECT tunneling is now disabled by default**: an empty `HttpServerConfig::connectAllowlist` now rejects every
  ...
  `connectAllowlist` JSON/YAML setting).
